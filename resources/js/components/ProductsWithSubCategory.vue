                        ...
                        <div class="card" id="card" style="max-width: 300px;box-shadow:5px 5px 5px gray">
                            <div class="card-header">
                                <img class="img-fluid w-100"
                                    :src="getAbsoluteImagePath(product.boutique[0].name, product.image1)" alt="">
                            ...
                            <div class="card-body" style="padding: 0">
                                ...
                                <h4 class="card-subtitle mb-2 float-start naslov" style="color: #65B741">{{ product.price
                                }}KM</h4>
                                <small class="card-subtitle mb-2 float-right podnaslov" style="color: #B80000"><del
                                        v-if="product.old_price != 0.00">{{ product.old_price }} KM</del></small>
                            </div>

                            <div class="card-footer" style="padding: 2px">
                                <a href="" style="border-radius: 5px"
                                    class="btn btn-primary btn-sm float-start mobile-button">Kupi</a>
                            </div>
                        </div>
                    </router-link>
                </div>
