                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" :src="getAbsoluteImagePath(product.image1)" alt="Trenutno nema slike">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" v-if="product.image2 != null" :src="getAbsoluteImagePath(product.image2)" alt="Trenutno nema slike">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" v-if="product.image3 !=null" :src="getAbsoluteImagePath(product.image3)" alt="Trenutno nema slike">
                        </div>
