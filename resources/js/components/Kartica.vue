<template>
 ...
 export default {
     ...
     methods: {
         ...
         async loadFavorites() {
             try {
                 const response = await axios.get('/api/products/all-fav');
                 this.inFavorites = response.data;
             } catch (error) {
         ...
         async addToFavorites(productId) {
             try {
                 await axios.get(`/api/product/add-to-fav/${productId}`);
         ...
         async removeFromFavorites(productId) {
             try {
                 await axios.get(`/api/product/remove-fav/${productId}`);
